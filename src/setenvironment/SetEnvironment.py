    ...
    def _helper_handler_common_module(self, section_name, handler_parameters) -> int:
        ...
        data structure's "setenvironment" entry. Results look something like:
            ...
            [
                ...
                {'op': 'module_load',   'module': 'sems-gcc',    'value': '4.8.4'},
                {'op': 'module_load',   'module': 'sems-boost',  'value': '1.10.1'},
                {'op': 'module_load',   'module': 'sems-python', 'value': '3.9.0'},
                {'op': 'module_load',   'module': 'sems-gcc',    'value': '4.8.4'},
                {'op': 'module_unload', 'module': 'sems-boost',  'value': ''},
                {'op': 'module_remove', 'module': 'sems-python', 'value': ''},
            ]
